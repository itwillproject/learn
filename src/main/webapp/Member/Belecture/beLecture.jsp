...
나의 지식을 나눠 사람들에게 배움의 기회를 주고, 의미있는 대가를 가져가세요.<br>
	아웃풋런은 지식으로 의미있는 수익과 공유가 가능한 한국 유일한 플랫폼 입니다.<br>
</p>
<br>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <h4 class="modal-title">지식공유에 동참해 주셔서 감사합니다!</h4>
          <h4 class="modal-title">아웃풋런의 이야기를 들어주세요!</h4><br>
          <h3>1. 아웃풋런은 성장기회의 평등을 추구합니다.</h3>
	<p>우리는 때로 무언가를 배워야만 합니다.
하지만 여러 이유로 당연하다고 생각되어 지는것들이 누군가에게는 사치가 되기도 합니다.
아웃풋런은 누구나, 경제적으로 시간적 제약없이 내가 원하는 것을 배우고, 지식을 나눌 수 있는 공간입니다.<br></p>
	<br>
	<h3>2. 전문 지식으로 수익이 가능한 유일한 곳.</h3>
	<p>아웃풋런은 기술 강의, 멘토링으로 의미 있는 보상을 가질 수 있는 유일한 플랫폼 입니다.
	 99만명의 수강생이 강의를 신청할 때마다 수익을 얻을 수 있어요!
지속가능한 수익과 명예를 가져가세요 :)<br></p>
	<br>
	<h3>3. 아웃풋런은 70% ~ 100% 의 비율의 높은 수익을 제공합니다.</h3>
	<p>좋은 지식은 합당한 보상에서 나온다고 아웃풋런은 생각합니다.
	 때문에 아웃풋런은 다른 학습 서비스에 비해 월등히 높은 수익을 드리고 있어요.
실제로 아웃풋런엔 꾸준히 월 수백 ~ 수천 만원 이상의 수익을 가져가는 많은 지식공유자들이 계셔요. <br></p>
	<br>
	<h3>4. 아웃풋런의 강의는 지식공유자가 자유롭게 운영할 수 있습니다.</h3>
...
<div class="col-sm-4" >
		...
		고, 지식의 가치를 존중하지 않는 일이라 생각합니다. 아웃풋런
		은 합리적인 가격 정책으로 지식공유자와 학습자 모두에게 도
		움이 되는 생태계를 만들어 가고 있습니다.</p>
      </div>
      <div class="col-sm-4" >
		<p>
		아웃풋런은 기술 강의로 의미 있는 보상을 가질 수 있는 유일한 플랫폼
...
<div class="col-sm-4" >
      ...
      <div class="col-sm-4" >
		<p>
		아웃풋런의 네트워크를 활용하세요.
		수많은 IT 기업에서 이미 아웃풋런과 연계를 맺고 함께 성장하고 있어요.
		아웃풋런에 강의를 개설한다면, 수많은 사람들과
...
<div class="row">
	...
	<div class="col-sm-8">
	<p>
		아웃풋런의 정산 비율은 기본적으로 70:30 으로 지식공유자분이 70%의 수익을 가져가세요 :) 정산은 매 10영업일 이내에 지급됩니다.
	</p>
	</div>
</div>
...
개인으로 강의를 제작하실 경우, 사업소득으로 신고되며,
 수익에서 원천세 3.3% 정산이 진행돼요. 원천세 신고 및 납부는 아웃풋런에서 모두 해 드립니다.
...
<div class="row">
	...
	<div class="col-sm-8">
		<p>
강의를 제작하고 나면 아웃풋런 운영팀에서 간단한 심사가 진행돼요.
...
<div class="row">
	<div class="col-sm-4">
		<b><span class="text-success">04.</span> 아웃풋런에서 강의를 편집해주시나요?
       강의 제작 팁 같은게 있을까요?</b><br>
	</div>
	<div class="col-sm-8">
		<p>
아웃풋런은 지식공유 플랫폼만 제공하며,
...
<div class="row">
	...
	<div class="col-sm-8">
		<p>
네. 아웃풋런에 강의를 올리면 실시간으로 수강생들의 신청기록을 확인할 수 있습니다.
   </p>
	</div>
</div>
