        ...
        <div class="col-8 pl-3 gray-line">
            ...
            <div class="pb-3">
                <ul class="border nav p-1">
                    <li class="nav-item"><a class="nav-link active" href="${pageContext.request.contextPath }/Member/myQuestion.do">질문</a>
                    </li>
            ...
            <div class="border">
                <div class="form-inline">
                    ...
                    <select id="statusSelect" name="status" class="form-control ml-2 mt-3" style="width: 125px" onchange="paging(1)">
                        <option value="1">전체</option>
                        <option value="2">해결됨</option>
                ...
                <script>
                  ...
                  function paging(cPage) {
                    ...
                    $.ajax({
                      data : data,
                      type : "GET",
                      url : "${pageContext.request.contextPath}/member/myQuestionAjax.do",
                    ...
                    <c:if test="${not empty list}">
                        <c:forEach var="free" items="${list }">
                            <div class="pt-1 pl-4 pr-4">
                                <h5>
                                    <a style="word-break: break-all" href="${pageContext.request.contextPath}/board/viewQnaPage.do?qboardNo=${free.qboardNo}"><b> ${free.boardTitle }</b></a>
                                </h5>
                                <c:choose>
