	...
	<div class="outer">
		<div class="inner">
			<ul class="menuborder">
			  ...
			  <li class="menu"><a class="active" href="${pageContext.request.contextPath }/Member/MemberBoard/privacyPolicy.jsp">개인정보 취급방침</a></li>
			</ul>
		</div>
	</div>
	<br>
		...
		<div class="inner2">
			...
			<ol>
				<li>"사이트"라 함은 회사가 회원에게 서비스를 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 설정한 가상의 영업장 또는 회사가 운영하는 아래의 웹사이트를 말합니다. 
					<ol type="a">
						<li>“서비스”라 함은 구현되는 단말기와 상관없이 “회원” 혹은 웹사이트 방문자가 이용할 수 있는 아웃풋런 서비스를 의미합니다.</li>
