...
<!--                                 	<input type="button" value="취소" onclick="cancelBoard(this.form)"> -->
									<input type="button" id="submitBoard" class="btn btn-success mr-3" value="등록" onclick="registBoard(this.form)">
									<input type="button" id="cancelWrite" class="btn btn-light mr-3" value="취소" onclick="cancelBoard(this.form)">
