...
<!--                                     <input type="button" class="btn btn-success" value="취소" onclick="cancel(this.form)"/> -->
									<input type="button" id="submitBoard" class="btn btn-success mr-3" value="수정" onclick="modifyGo(this.form)">
									<input type="button" id="cancelWrite" class="btn btn-light mr-3" value="취소" onclick="cancel(this.form)">
                                </td>
                            </tr>
                        </tbody>
                    </table>
