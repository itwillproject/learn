    ...
    <div class="row w-100 pb-4 justify-content-center">
        ...
        <div class="col-8 pl-3 gray-line">
			<div class="d-flex flex-row p-3 writeComments">
				<form method="post" class="w-100" action="${pageContext.request.contextPath}/insertLectureNews.do"> 
					<table class="table table-borderless">
						<thead>
							<tr>
								<th>
									<h2><b><input class="w-100 mx-auto border border-0" type="text" name="newsTitle" placeholder="제목을 입력하세요."></b></h2>
								</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td>
									<textarea class="w-100 mx-auto" id="summernote" name="newsContent"></textarea>
									<script>
								...
								<td>
									<div class="outer">
										<div class="button">
									 		...
									 		<button type="button" class="btn btn-dark" onclick="location.href='${pageContext.request.contextPath}/getLectureNewsList.do?lectureNo=${lectureNo }'">취소</button>
									 		<input type="hidden" class="btn btn-dark" name="lectureNo" value="${lectureNo }">
									 	</div>
							 		</div>
								</td>
							</tr>
