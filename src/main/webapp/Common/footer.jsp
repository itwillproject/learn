...
<footer class="footer">
  ...
  <div class='menu_list '>
    ...
    <div class='menu_sublist'> <a href='/inflearn'  class='list_link'>인프런 소개</a><a href='/pages'  class='list_link'>인프런 피드</a><a href='/community/reviews'  class='list_link'>수강평 모아보기</a>
    </div>
  </div>
  <div class='menu_list '>
    <div class='list_title'>
      신청하기
      <span class='is-mobile list_caret'><i class='far fa-angle-up'></i><i class='far fa-angle-down'></i></span></div>
    <div class='menu_sublist'> <a href='/open-knowledge'  class='list_link'>지식공유참여</a><a href='/mentors-intro'  class='list_link'>멘토링 소개</a><a href='/intro-group'  class='list_link'>인프런 비즈니스</a><a href='/university'  class='list_link'>인프런 X 대학교</a><a href='/partners/aws'  class='list_link'>인프런 X AWS 제휴</a>
    </div>
  </div>
  <div class='menu_list '>
    <div class='list_title'>
      코드 등록
      <span class='is-mobile list_caret'><i class='far fa-angle-up'></i><i class='far fa-angle-down'></i></span></div>
    <div class='menu_sublist'> <a href='/course-code'  class='list_link'>수강코드 등록</a><a href='/point-code'  class='list_link'>포인트코드 등록</a>
    </div>
  </div>
  <div class='menu_list '>
    <div class='list_title'>
      고객센터
      <span class='is-mobile list_caret'><i class='far fa-angle-up'></i><i class='far fa-angle-down'></i></span></div>
    <div class='menu_sublist'> <a href='/notices'  class='list_link'>공지사항</a><a href='/faq'  class='list_link'>자주묻는 질문</a><a href='/copyright'  class='list_link'>저작권 신고센터</a><a href='/certificate'  class='list_link'>수료증 확인</a><a href='/request-to-inflearn'  class='list_link'>강의 · 기능요청</a>
    </div>
  </div>
  <div class='menu_list '>
    <div class='list_title'>
      인프랩
      <span class='is-mobile list_caret'><i class='far fa-angle-up'></i><i class='far fa-angle-down'></i></span></div>
    <div class='menu_sublist'> <a href='https://doc.clickup.com/d/3gfz7-5843/log/3gfz7-75205/%EC%9D%B8%ED%94%84%EB%9E%A9-%EC%8B%A4-log' target="_blank" class='list_link'>인프랩 실Log</a><a href='/pages/withus'  class='list_link'>인프랩 채용</a><a href='https://story.inflab.com/'  class='list_link'>인프랩 스토리</a><a href='https://tech.inflab.com/'  class='list_link'>인프랩 테크</a>
    </div>
  </div></div>
