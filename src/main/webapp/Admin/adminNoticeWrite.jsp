	...
	<div class="main">
		<div class="col-sm-6 align-content-center">
			<div class="d-flex flex-row p-3 writeComments">
				<form method="get" class="w-100" action="${pageContext.request.contextPath}/insertNotice.do" enctype="multipart/form-data"> 
<!-- 				<form method="get" class="w-100" action="#" enctype="multipart/form-data">  -->
					<table class="table table-borderless">
						<thead>
							<tr>
								<th>
									<h2><b><input class="w-100 mx-auto border border-0" type="text" name="boardTitle" placeholder="제목을 입력하세요."></b></h2>
								</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td>
									<textarea class="w-100 mx-auto" id="summernote" name="boardContent"></textarea>
									<script>
								...
								<td>
									<div class="outer">
										<div class="button">
									 		...
									 		<button type="button" class="btn btn-dark" onclick="location.href='${pageContext.request.contextPath}/getNoticeAdminList.do'">취소</button>
									 	</div>
							 		</div>
								</td>
							</tr>
